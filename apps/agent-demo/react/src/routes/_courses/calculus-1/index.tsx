...
const lessons = [
  ...
  { id: '04', title: 'Average rate of change', path: '/calculus-1/lesson-04' },
  { id: '05', title: 'Estimating limits', path: '/calculus-1/lesson-05' },
  { id: '06', title: 'Infinite limits', path: '/calculus-1/lesson-06' },
  { id: '07', title: 'Continuity', path: '/calculus-1/lesson-07' },
  { id: '08', title: 'Limits at infinity', path: '/calculus-1/lesson-08' },
  { id: '09', title: 'Derivatives from first principles', path: '/calculus-1/lesson-09' },
  { id: '10', title: 'Derivative rules', path: '/calculus-1/lesson-10' },
  { id: '11', title: 'Product and quotient rules', path: '/calculus-1/lesson-11' },
  { id: '12', title: 'Chain rule', path: '/calculus-1/lesson-12' },
]
