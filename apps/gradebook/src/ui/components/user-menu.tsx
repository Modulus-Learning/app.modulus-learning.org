        ...
        <Dropdown.Portal>
          ...
          >
            ...
            <Dropdown.Separator
              ...
              // announced item count ("3 items" reported as 4). Hide it from the
              // accessibility tree so only the actual menu items are counted.
              role="presentation"
              aria-hidden="true"
              className="my-1 border-t border-t-gray-300 dark:border-t-gray-900 w-[90%] mx-auto"
            />
            <Dropdown.Item>
