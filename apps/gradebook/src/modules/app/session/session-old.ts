...
// export const SESSION_VALID_HEADER = 'X-MODULUS-USER-SESSION-VALID'
...
//   return cookieStore.get(config.cookies.userSession.name)?.value
// }
...
//   cookieStore.set(config.cookies.userSession.name, access_token, sessionCookieOptions())
//   cookieStore.set(config.cookies.userRefresh.name, refresh_token, refreshCookieOptions(remember_me))
// }
...
//   const config = getServerConfig()
//   const cookieStore = await cookies()
//   cookieStore.delete(config.cookies.userSession.name)
//   cookieStore.delete(config.cookies.userRefresh.name)
// }
...
//   const refresh_token = request.cookies.get(config.cookies.userRefresh.name)?.value
...
//     request.cookies.get(config.cookies.userSession.name)?.value
//   )
