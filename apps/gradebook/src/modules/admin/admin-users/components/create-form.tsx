...
import { adminUserCreateSchema } from '../@types'
import { createAdminUser } from '../create'
import type { Locale } from '@/i18n/i18n-config'
import type { AdminRole, AdminUserFormState } from '../@types'
...
export function AdminUserCreateForm({
  ...
  const [formState, formAction, isPending] = useActionState(createAdminUser, initialState)
  const resolver = zodResolver(adminUserCreateSchema)
  const {
    control,
    register,
      ...
      >
        ...
        <div className="form-actions flex gap-2 justify-end my-4">
          <Button
            ...
            intent="noeffect"
            render={<LangLink href="/admin/admin-users" lng={lng} />}
          >
