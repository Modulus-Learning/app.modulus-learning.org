...
`.agents/rules/conventional-commits.md` — follow it exactly; do not invent new types
...
3. Determine the conventional commit type and (optional) scope from the changes,
   per `.agents/rules/conventional-commits.md`. In short: `type(scope): lowercase
...
6. DO NOT create a co-authored commit. Never include "Co-Authored-By" or any
   AI-attribution trailer in the commit message. This
