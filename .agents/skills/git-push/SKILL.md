---
name: git-push
description: Use when asked to push the current branch or its commits to the remote repository. Checks the worktree, upstream, and outgoing commits before requesting confirmation and pushing.
---
